...
class Database():
    ...
    def AddData2Database(self, DataName, Data, GroupName, Parents=None):
        ...
        .. note::
           Do not use Parent option right now.
           It is untested and likely to fail.
    ...
    def RemoveChild(self, ChildName, option=0):
        ...
        :returns: deletes child. This is a less severe than \
            RemoveNeuron. It will not delete all of the children.
        ...
        if option == 0:
            decision = raw_input('Are you absolutely sure you want to \
                         delete this child permenently? (y/n): ')
            if decision.lower() == 'y' or decision.lower() == 'yes':
    ...
    def ImportDataFromMatlab(self, FileName, NeuronName):
        ...
        .. todo::
           * Generalize. NeuronName makes sense here for now, but \
               eventually would like to import everything.
    ...
    def AddGitVersion(self, NeuronName, Action, GitDir = './dist'):
        ...
        if self.Exists('git', NeuronName) is False:
